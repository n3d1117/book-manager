...
public class BookTransactionalServiceTest {
	...
	@InjectMocks
	private BookTransactionalService bookService;
	...
	public void testAddBookShouldFailWhenAlreadyInDatabase() {
		...
		BookDuplicateException e = assertThrows(BookDuplicateException.class, () -> bookService.add(BOOK_FIXTURE_1));
	...
	public void testDeleteBookThrowsExceptionWhenItDoesNotExist() {
		...
		BookNotFoundException e = assertThrows(BookNotFoundException.class, () -> bookService.delete(bookIdToDelete));
